...
ECHO.
ECHO.
ECHO  Press D - Clean Healbot files in your WTF directory and check libQuickHealth doesn't exist
ECHO.
...
rmdir .\Libs\LibQuickHealth-2.0 /s /q

echo Removed LibQuickHealth-2.0 ** Completed **
echo.

 --Mage Nuggets 2.2 by B-Buck (Bbuck of Eredar)
...
function MageNuggets_SlashCommandHandler(msg) --Handles the slash commands
    ...
    DEFAULT_CHAT_FRAME:AddMessage("|cffffffff------------|cff00BFFF".."Mage".." |cff00FF00".."Nuggets".."|cffffffff 2.2--------------")
       ...
       if(MageNugz.igniteTog == true)then   
        ...
        if (event1 == "SPELL_DISPEL") and (sourceName == UnitName("player")) then
            if (MageNugz.ssMonitorToggle == true) then
                ...
                if (MageNugz.consoleTextEnabled == true) then
                    DEFAULT_CHAT_FRAME:AddMessage("|cffFFFFFF".."Dispelled "..GetSpellLink(spellId1).." From "..destName)
	    	    end
            end
        end
        ...
        if event1 == "SPELL_AURA_APPLIED" then
            ...
            if (MageNugz.polyToggle == true) then
                ...
                if (arg == 54646) then
                    if (MageNugz.fmnmsgToggle == true) then
            ...
            if destName == UnitName("player") then
                ...
                if (arg == 54646) then
                    ...
                    if (MageNugz.fmtyToggle == true) then
...
function MNVariablesLoaded_OnEvent() --Takes care of the options on load up
        ...
        if(mnenglishClass == 'WARLOCK') then
            DEFAULT_CHAT_FRAME:AddMessage("|cff00BFFF".."Mage".."|cff00FF00".."Nuggets".."|cffffffff 2.2 ".."loaded! Some Options Disabled (Class:"..UnitClass("Player")..")")
            MageNugz.igniteTog = false;
            MageNugz.ssMonitorToggle = false;
            MageNugz.mageProcToggle = false;
            MageNugz.mirrorImageToggle = false;
        ...
        if(mnenglishClass == 'MAGE') then
            DEFAULT_CHAT_FRAME:AddMessage("|cff00BFFF".."Mage".."|cff00FF00".."Nuggets".."|cffffffff 2.2 ".."loaded! (Use: /magenuggets options)")
            MageNugCD_Frame_Text:SetText(" ");
            MageNugz.moonkinTog = true;
            MageNugMoonkin_Frame:Hide()
            MNmoonFire_Frame:Hide();
        ...
        if (MageNugz.fmnmsgToggle == nil) then
            MageNugz.msgToggle = true;
        end
        if (MageNugz.fmnmsgToggle == true) then
        ...
        if (MageNugz.fmtyToggle == nil) then
            MageNugz.fmtyToggle = true;
        end
        if (MageNugz.fmtyToggle == true) then
...
function MNfocusMagicNotifyToggle() -- Focus magic notify toggle
    ...
    if (msgTog == 1) then
	    MageNugz.fmnmsgToggle = true; 
    else
        MageNugz.fmnmsgToggle = false;
    end
end

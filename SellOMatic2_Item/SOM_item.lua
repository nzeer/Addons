...
--				elseif itemRarity == 2 and SellOMatic.db.profile.allowGreen and not item_tooltip:Find(ITEM_BIND_ON_EQUIP,1,3) and not item_tooltip:Find(ITEM_SOULBOUND,1,3) then
--					add = 1;
